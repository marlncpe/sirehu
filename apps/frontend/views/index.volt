   ...
   {{ content() }}
    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-12">
          <div class="copyright">
            Copyright 2014 - 2015 Paperclip Tema creado por <a href="https://twitter.com/YevSim">Yevgeny S.</a>  Modificado por <a href="https://twitter.com/YevSim">Marlon Cepeda</a> | Todos los Derechos Reservados
          </div>
        </div>
      </div>  <!-- / .row -->
    </div> <!-- / .container -->
