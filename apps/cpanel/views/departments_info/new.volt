                     ...
                     <div class="main-box-body clearfix">
                        {{ form("cpanel/departments/information/create", "method":"post") }}
                           <div class="form-group">
                              ...
                              <textarea class="form-control" name="titulo" rows="3" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Tienes un limite de 180 letras para crear el titulo del servicio a ofrecer por el departamento o coordinacion"required></textarea>
